...
<title>宁静致远地图_网站宗旨 - 宁静致远 - 刘宁</title>

<meta name="baidu_union_verify" content="1f4bf8fb796d8702f9dcff06a09ed8ff">
<meta name="keywords" content="宁静致远,仙侠地图,同城,天高任鸟飞,宁静致远,刘宁,个人网站" />
<meta name="description" content="有梦就有追逐,有爱就有快乐,海阔任鱼跃,天高任鸟飞,与刘宁一起在宁静致远个人随笔网站追逐梦想!" />
...
<script type="text/javascript" src="https://api.map.baidu.com/api?v=2.0&ak=yb9vWUgl5q6P1fBfyOPPvXg5Wk6j4oO9&s=1"></script>
<style type="text/css">
#map_bg{ 
    position:absolute;    
    top: 0;
...
<div style="width:960px;height:2000px;position:relative;">
    <div id="allmap"></div>
    <img id="map_bg" src="/public/static/index/images/gufeng/xiami.png" usemap="#newbook" style="width:960px;"/>
    <area shape="rect" coords="56,69,78,139" href="urlall.htm" target="_blank" alt="虾米联盟地址" title="虾米联盟地址"> 
</div>
<script type="text/javascript">
    // 百度地图API功能
    var map = new BMap.Map("allmap");
    var point = new BMap.Point(113.9218026184,22.5380008582);
    map.centerAndZoom(point, 13);

    var pt = new BMap.Point(113.9218026184,22.5380008582);
