...
<title>前端_后端技术分享 - 宁静致远 - 刘宁</title>

<meta name="baidu_union_verify" content="1f4bf8fb796d8702f9dcff06a09ed8ff">
<meta name="keywords" content="php,前端,宁静致远,刘宁,个人网站" />
<meta name="description" content="web前端技术和PHP技术的技术笔记,附带部分源码下载学习！" />
...
<style type="text/css">
.item-box .comlimi_tc { margin: 0px 15px;padding: 10px 0px 10px;overflow: hidden;}
.index-item .left{width:333px;height:auto;float:left;}
.index-item .right{ width:333px;height:auto;float:left;}
.comlimi_tc ul{height:264px;}
</style>
<div class="wp">
...
<div id="ct" class="ct2 wp cl">
    <div class="article-left">
        <div id="listlooptop" class="area">
            <div id="frame5cvJUH" class="frame move-span cl frame-1">
                <div id="frame5cvJUH_left" class="column frame-1-c">
                    <div id="frame5cvJUH_left_temp" class="move-span temp"></div>
                    <div id="portal_block_3943" class="cl_block_bm block move-span">
                        <div id="portal_block_3943_content" class="dxb_bc">
        ...
        <div class="comlimi_title cl">
            <span class="y" style="width:550px;overflow:hidden;height:35px;">  
  
            </span>
            <dt class="ico-07"><h1>编程技术</h1></dt>
        </div>
        <div class="index-item cl">
            <!-- 左边主要内容 开始 -->
            <?php foreach($data as $vo):?>
                        <div class="<?php echo $vo['localtion']?>">
                    <div class="item-box item-box-y">
                        <div class="comlimi_ta cl">
                            <h2><a href="javascript:void(0);" title="<?php echo $vo['name']?>"><?php echo $vo['name']?></a></h2>
                        </div>
                        <div class="comlimi_tc">                                                                                
                            <div class="pic">
                                <a href="<?php echo U('/articleType/index',array('id'=>$vo['id']))?>" title="<?php echo $vo['title']?>"><img src="<?php echo $vo['img']?>" class="lazy" alt="<?php echo $vo['title']?>"/><h4><?php echo $vo['title']?></h4></a>
                            </div>                                                                                        
                            <ul>
                            <?php foreach($vo['content'] as $v):?>
                                <li>
                                    <span class="time"><?php echo date("m-d",$v['time'])?></span>
                                    <a href="<?php echo U('/article/index',array('id'=>$v['id']))?>" target="_blank"><?php echo $v['title']?></a>
                                </li>
                            <?php endforeach;?>
