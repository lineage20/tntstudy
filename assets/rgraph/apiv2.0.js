...
(function () {
                    ...
                    if (e.f_ == o) {
                        ...
                        e.getTilesUrl = function (b, d) {
                            var e = b.x,
                                ...
                                l = 1;
                            this.map.Fx() && (l = 2);
                            l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=20170624&scale=" + l + "&ak=" + qa;
    ...
    Yc.getTilesUrl = function (a, b, c) {
        ...
        return (Wc[Math.abs(d + a) % Wc.length] + "?qt=tile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + e + (6 == x.da.la ? "&color_dep=32&colors=50" : "") + "&udt=20170624").replace(/-(\d+)/gi, "M$1")
    };
    var Ma = new Uc("\u5730\u56fe", Yc, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
