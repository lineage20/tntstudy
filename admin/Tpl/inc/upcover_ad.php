...
<style>
    .uploadbox {
        width: 281px;height:500px;overflow:hidden;margin-top:5px;margin-right:10px;cursor:pointer
    }
        .uploadbox > .wait {
            position:absolute;z-index:99999;margin:35px auto auto 85px;display:none;
        }
        .uploadbox > .imgcover {           
            max-height:100%;
            max-width:100%;
...
<div id="divCover" class="uploadbox">
